...
function Header(props) {
  ...
  //filters sur article data

  // ajout de l'icone dans le hearder + la fonction click sur le bouton pour masquer les articles
  let iconStyle = {};
    ...
    if (isModalVisible) {
      ...
      userSection = (
        <div className={styles.headerIcons}>
          ...
          />
          <button>
            <FontAwesomeIcon onClick={() => unHiddenClick()} icon={faEye} />
          </button>
        </div>
      );
    }
